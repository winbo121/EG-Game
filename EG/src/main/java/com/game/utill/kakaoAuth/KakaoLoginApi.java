...
public class KakaoLoginApi {
    ...
    private final static String CLIENT_ID = "20181428c4092bcfb467a93b839a8b05";
    private final static String REDIRECT_URI = "http://localhost:8080/EG/kakaoLoginCallback";
    private final static String PROFILE_API_URL = "https://kapi.kakao.com/v2/user/me";
    
    
    
    public String kakaoGetAuthorizationUrl(HttpSession session) {
    	 

        OAuth20Service oauthService = new ServiceBuilder(CLIENT_ID)                                                   
                .callback(REDIRECT_URI)
                .build(KakaoLoginInstance.instance());
