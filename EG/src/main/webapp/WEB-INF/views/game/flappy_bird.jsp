...
<link rel="stylesheet" type="text/css" href="../../css/main.css" />
	...
	<script type="text/javascript" src="../../controller/js/game/flappy_bird/menu.js"></script>
	<!-- 게임을 플레이 할 수 있게 해주는 파일 -->
	<script type="text/javascript" src="../../controller/js/game/flappy_bird/game.js"></script>
	<!-- 단순 game over 이미지를 출력해주며, 클릭시 다시 게임으로 진입한다.-->
	<script type="text/javascript" src="../../controller/js/game/flappy_bird/game_over.js"></script>
	<!-- 모든 js 를 컨트롤 하는 파일 -->
	<script type="text/javascript" src="../../controller/js/game/flappy_bird/main.js"></script>
<body>
	<div id="g_header"></div>
	<div id="section">
		<div id="title">
